/*==============================================================================
DO FILE NAME:			A4 - ethnicity cumulative incidence.do
...
* Log
cap log close
log using $Logdir\A4_ethnicity_cumulative_incidence.log, replace
...
stcurve, failure at1(treatmentgroup=1) at2(treatmentgroup=2) at3(treatmentgroup=3) ///
	...
	legend(order(1 "SU" 2 "DPP4i" 3 "SGLT2i"))
graph save "Graph" "$Outputdir/cox_failure_mace_white.gph", replace
...
stcurve, failure at1(treatmentgroup=1) at2(treatmentgroup=2) at3(treatmentgroup=3) ///
	...
	legend(order(1 "SU" 2 "DPP4i" 3 "SGLT2i"))
graph save "Graph" "$Outputdir/cox_failure_mace_southasian.gph", replace
...
stcurve, failure at1(treatmentgroup=1) at2(treatmentgroup=2) at3(treatmentgroup=3) ///
    ...
    ytitle("proportion with MACE") ///
    xtitle("years since initiating on second-line medication") ///
	title("Cumulative incidence of MACE in the Black group") ///
	legend(order(1 "SU" 2 "DPP4i" 3 "SGLT2i"))
graph save "Graph" "$Outputdir/cox_failure_mace_black.gph", replace
