...
* Log
cap log close
log using $Logdir/A1b_baseline_characteristics.log, replace

********************************************************************************
** Create table of characteristics for missing vs no missing
********************************************************************************
* Set locals
local covariates imd region bmi_cat hba1c_cat alcoholabuse smoking
...
local rownames sample treatmentgroup su dpp4i sglt2i age_index gender male female ethnicity white southasian black other mixed notstated imd 1 2 3 4 5 region 1 2 3 4 5 6 7 8 9 t2dduration_years hba1c_cat 1 2 3 bmi_cat underweight normal overweight obese alcoholabuse yes no smoking non-smoker current former healthcare 1to10 morethan10 comorbidities $comorbidities medications $medications 
