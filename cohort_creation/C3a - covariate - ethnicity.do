/*=========================================================================
DO FILE NAME:			C3a - covariate - ethnicity.do

AUTHOR:					Mia Harley, adapted from Rohini Mathur's ethnicity do file

DATE CREATED: 			01/2024

DATE LAST UPDATED: 		01/2024
						
DATASETS CREATED:      	confounder_ethnicity.dta
					
DESCRIPTION OF FILE:	determines the ethnicity of the people in the study population
*=========================================================================*/
...
* Set up log
cap log close
log using $Logdir/C3a_covariate_ethnicity.log, replace

********************************************************************************
** Run Rohini's ethnicity algorithm **
********************************************************************************

**** CLEAN & CATEGORISE ETHNICITY
use "$Datadir\intermediate\ethnicity.dta", clear
codebook patid
...
gsort patid -count
sum uniqueeth //people have up to a maximum of X different ethnicities
...
save "$Datadir/derived/covariate_ethnicity.dta", replace


**MAKE PATIENT LEVEL FILE
**drop duplicate patids
use "$Datadir\raw\\${file_stub}_Extract_Patient_1", clear

merge 1:m patid using "$Datadir/derived/covariate_ethnicity.dta", gen(merge2)
