/*==============================================================================
DO FILE NAME:			A10 - ethnicity sens analysis - fucap.do
...
* Log
cap log close
log using $Logdir\A4c_ethnicity_sens_analysis_fucap.log, replace
...
* Create excel file
putexcel set "$Outputdir/Ethnicity sens analysis - fucap.xlsx", sheet("`outcome'") modify
