/*==============================================================================
DO FILE NAME:			A5e - sex sens analysis - per protocol with ipcw
...
* Log
cap log close
log using $Logdir/A5e_sex_sens_analysis_ipcw_weights.log, replace
...
** Set up excel **
********************************************************************************
putexcel set "$Outputdir/Sex sens analysis - as treated ipcw.xlsx", sheet("mace") modify
...
putexcel A4 = "Adjusted"

putexcel A5 = "SGLT2i vs SU"
putexcel A6 = "Unadjusted"
putexcel A7 = "Adjusted"

putexcel A8 = "SGLT2i vs DPP4i"
putexcel A9 = "Unadjusted"
putexcel A10 = "Adjusted"
...
foreach model in unadjusted fully {
...
stset _t [pweight=sw_ipcw_trunc], fail(_d) origin(_t0)
stcox i.treatmentgroup##i.gender ``model'', base cluster(patid)
...
putexcel B2 = ("P-interaction=" + string(r(p), "%9.3f"))

* SGLT2i vs SU
test 3.treatmentgroup#1.gender 3.treatmentgroup#2.gender
putexcel B5 = ("P-interaction=" + string(r(p), "%9.3f"))

* SGLT2i vs DPP4i
stset _t [pweight=sw_ipcw_trunc], fail(_d) origin(_t0)
stcox ib2.treatmentgroup##i.gender $full_adj_covariates, base cluster(patid)
test 3.treatmentgroup#1.gender 3.treatmentgroup#2.gender
putexcel B8 = ("P-interaction=" + string(r(p), "%9.3f"))
